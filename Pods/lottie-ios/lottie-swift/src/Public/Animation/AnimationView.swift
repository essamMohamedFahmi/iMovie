  ...
  */
   ...
   */
    public func play(
        ...
        guard let animation = animation, let markers = animation.markerMap,
            let to = markers[toMarker]
        else {
            return
        }
   ...
   */
        ...
        if let viewportFrame = self.viewportFrame {
            ...
            case .scaleAspectFit:
                ...
                let dominantDimension =
                    compAspect > viewAspect ? bounds.size.width : bounds.size.height
                let compDimension =
            ...
            case .bottomRight:
                ...
                @unknown default:
                    print(
                        "unsupported contentMode: \(contentMode.rawValue); please update lottie-ios"
                    )
                    xform = CATransform3DIdentity
            #endif
            }
    ...
    fileprivate func addNewAnimationForContext(_ animationContext: AnimationContext) {
        ...
        if timeOffset != 0 {
            ...
            layerAnimation.beginTime =
                currentLayerTime - (timeOffset * 1 / Double(abs(animationSpeed)))
        }
