...
final class AnimationContainer: CALayer {
    ...
    init(
        animation: Animation, imageProvider: AnimationImageProvider,
        textProvider: AnimationTextProvider, fontProvider: AnimationFontProvider
    ) {
        ...
        let layers = animation.layers.initializeCompositionLayers(
            ...
            textProvider: textProvider, fontProvider: fontProvider,
    ...
    public override init(layer: Any) {
        self.animationLayers = []
        self.layerImageProvider = LayerImageProvider(
            imageProvider: BlankImageProvider(), assets: nil)
