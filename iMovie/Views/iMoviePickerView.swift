        ...
        VStack(alignment: .leading, spacing: 2) {
            ...
            case .popural:
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: 15) {
                        iMovieCardView(moviePoster: "MoviePoster", movieTitle: "The good doctor", movieReleaseDate: "Jan 26, 2017", rateColor: .iMoviePurpure, rate: 0.75)
                        iMovieCardView(moviePoster: "MoviePoster", movieTitle: "The good doctor", movieReleaseDate: "Jan 26, 2017", rateColor: .iMoviePurpure, rate: 0.75)
                        iMovieCardView(moviePoster: "MoviePoster", movieTitle: "The good doctor", movieReleaseDate: "Jan 26, 2017", rateColor: .iMoviePurpure, rate: 0.75)
                    }
